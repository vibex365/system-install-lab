    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20">
        <div className="container max-w-sm">
          <h1 className="text-3xl font-bold tracking-tight text-foreground mb-2 text-center">Access PFSW</h1>
          <p className="text-muted-foreground text-center mb-8">Log in or create an account.</p>
