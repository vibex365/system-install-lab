...
import { ExternalLink, Copy, BarChart3, Users, MousePointerClick } from "lucide-react";
...
export default function AdminMarketing() {
  ...
  const copyUrl = () => {
    navigator.clipboard.writeText(FUNNEL_URL);
        ...
        <Card className="bg-card border-border">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center gap-2 bg-secondary rounded-lg px-3 py-2">
              ...
              <Button size="sm" variant="ghost" onClick={copyUrl} className="shrink-0">
